...
public class ModelResourceFile extends ResourceFile {
    ...
    public int getWidth() {
	return (int)(mBoundingBox.mPointB.x - mBoundingBox.mPointA.x) + 1;
    }
    
    public int getLength() {
	return (int)(mBoundingBox.mPointB.y - mBoundingBox.mPointA.y) + 1;	
    }
    
    public int getHeight() {
	return (int)(mBoundingBox.mPointB.z - mBoundingBox.mPointA.z) + 1;
    }
