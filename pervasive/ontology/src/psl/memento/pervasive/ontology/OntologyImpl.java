...
public class OntologyImpl implements Ontology {
	...
	public OntologyImpl (Properties settings) {
	 ...
	 **/
	public void updateNode(OntologyNodeImpl node) {
		long start = System.currentTimeMillis();
		accessesUpdateNode++;
	...
	public OntologyNode getNode(long id) {
		...
		OntologyNodeImpl node = loadFromCache(id);
	 ...
	 **/
	private OntologyNodeImpl loadFromCache(long id) {
		...
		if (nodeObj == null) {
			...
			OntologyNodeImpl node = (OntologyNodeImpl)nodeObj;
	 ...
	 **/
	private void insertIntoCache(OntologyNodeImpl node) {
		//Get new access time
		long newAccess = System.currentTimeMillis();
		Long newAccessObj = new Long(newAccess);
